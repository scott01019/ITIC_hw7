...
if (isset($_SESSION['register_errors'])) {  //  check if any errors are reported from prior requests
  echo '<div class="alert alert-danger text-center col-md-7 col-md-offset-2" role="alert">' . $_SESSION['register_errors'] . '</div>';
  unset($_SESSION['register_errors']);
}
?>
<form class="form-horizontal col-md-6 col-md-offset-2 form" method='post' action='register_user.php'>
